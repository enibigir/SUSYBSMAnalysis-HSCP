...
# defaults
#options.inputFiles="file:HSCPgluino_M-1800_2018_DBED7237EDF1.root"
options.outputFile = 'Histos.root'
# -1 means all events
options.maxEvents = -1

options.register('SAMPLE', 'isSignal',VarParsing.multiplicity.singleton,VarParsing.varType.string,
                 "Sample Type. Use: isSignal or isBckg or isData"
)
options.register('YEAR', '2018',VarParsing.multiplicity.singleton,VarParsing.varType.string,
                 "Year. Use: 2017 or 2018"
)
options.register('isSkimmedSample', False,VarParsing.multiplicity.singleton,VarParsing.varType.bool,
...
def get_GTAG(year):
    switcher = {
        ...
        '2018': "106X_upgrade2018_realistic_v11BasedCandidateTmp_2022_08_09_01_32_34",
    }
    return switcher.get(year, "WRONG_GTAG")
...
print('Sample Type   : {} {}'.format(options.SAMPLE,options.YEAR))
...
#   fileNames = cms.untracked.vstring("root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL18RECO/HSCPgluino_M-1800_TuneCP5_13TeV-pythia8/AODSIM/106X_upgrade2018_realistic_v11_L1v1-v2/80000/236673F3-65E3-A745-AEFE-DBED7237EDF1.root"),
...
process.GlobalTag = GlobalTag(process.GlobalTag, get_GTAG(options.YEAR), '')
...
process.HSCParticleAnalyzer.DebugLevel = 0 #6 
