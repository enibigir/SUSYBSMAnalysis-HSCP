...
void TupleMaker::initializeTuple(Tuple *&tuple,
  ...
  tuple->NumEvents = dir.make<TH1F>("NumEvents", ";;Number of events / category", 9, 0.5, 9.5);
  ...
  tuple->NumEvents->GetXaxis()->SetBinLabel(6,"Events w/ event weights * 1");         //LACEY (added bin number 6)
  tuple->NumEvents->GetXaxis()->SetBinLabel(7,"Events w/ event weights * radiation"); //LACEY (added bin number 7)
  tuple->NumEvents->GetXaxis()->SetBinLabel(8,"Events w/ event weights * rad. Up");   //LACEY (added bin number 8)
  tuple->NumEvents->GetXaxis()->SetBinLabel(9,"Events w/ event weights * rad. Down"); //LACEY (added bin number 9)
